...
This command processes your schema file and generates interactive ERD visualization files in the `dist` directory. The schema format is automatically detected, but you can override it using the `--format` option if needed.
