...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm" copyable>npx @liam-hq/cli erd build --format schemarb --input db/schema.rb</Tab>
  <Tab value="pnpm" copyable>pnpm dlx @liam-hq/cli erd build --format schemarb --input db/schema.rb</Tab>
  <Tab value="yarn" copyable>yarn dlx @liam-hq/cli erd build --format schemarb --input db/schema.rb</Tab>
  <Tab value="bun" copyable>bun x @liam-hq/cli erd build --format schemarb --input db/schema.rb</Tab>
</Tabs>
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm" copyable>npx @liam-hq/cli erd build --format postgres --input db/structure.sql</Tab>
  <Tab value="pnpm" copyable>pnpm dlx @liam-hq/cli erd build --format postgres --input db/structure.sql</Tab>
  <Tab value="yarn" copyable>yarn dlx @liam-hq/cli erd build --format postgres --input db/structure.sql</Tab>
  <Tab value="bun" copyable>bun x @liam-hq/cli erd build --format postgres --input db/structure.sql</Tab>
</Tabs>
...
## Pro Tips: When Associations Don’t Appear in the ER Diagram
...
Try the above tips and tricks to get the most out of Liam ERD in your Rails projects. If foreign keys are clearly defined, you can generate a concise, easy-to-understand visualization of your database structure.
